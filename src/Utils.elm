module Utils exposing (appendIf, concatIf, loremIpsum, maybeAppend)
...
-- type alias BreakpointModifications =
--     { padding: PD.Padding }
-- type alias Modifications =
--     { small : BreakpointModifications
--     , medium : BreakpointModifications
--     , large : BreakpointModifications
--     , extraLarge : BreakpointModifications
